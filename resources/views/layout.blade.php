{{--
    ...
    person's menu (a native popover, so the package needs no Flux JS). An
    app that declares no manifest has not said it is a Scalpels app, so its
    shell stays unbranded: no header at all.
