...
$exemptFromCitation = [
    ...
    'resources/views/authorizations/device.blade.php' => 'package form template; structural rendering and test-created authorization data are driven by DeviceAuthorizationHttpTest',
