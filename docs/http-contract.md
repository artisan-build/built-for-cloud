...
**Everything the Console adds through 0.10.0 is additive, so `api_version` stays 2. What carries the
signal is `bfc_version` 0.10.0 plus the `capabilities` entries** — `console-keys`,
